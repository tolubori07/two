...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:en,depthTest:!1,depthWrite:!1})}function Xs(){return new Sn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:zr(),fragmentShader:`
		...
		`,blending:en,depthTest:!1,depthWrite:!1})}function Ys(){return new Sn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:zr(),fragmentShader:`
